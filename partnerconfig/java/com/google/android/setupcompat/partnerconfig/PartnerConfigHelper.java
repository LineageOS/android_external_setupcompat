...
public class PartnerConfigHelper {
  ...
  public boolean isPartnerConfigAvailable(PartnerConfig resourceConfig) {
    if (resultBundle != null && !resultBundle.isEmpty())
      ...
      int resId = mContext.getResources().getIdentifier(resourceConfig.getResourceName(), resType, mContext.getPackageName());
      return (resId != 0);
    }
  }
  ...
  public String getString(@NonNull Context context, PartnerConfig resourceConfig) {
    ...
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "string", context.getPackageName());
  ...
  public List<String> getStringArray(@NonNull Context context, PartnerConfig resourceConfig) {
    ...
    Resources appResource = context.getResources();
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "array", context.getPackageName());
  ...
  public boolean getBoolean(
    ...
    Resources appResource = context.getResources();
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "bool", context.getPackageName());
  ...
  public float getDimension(
    ...
    Resources appResource = context.getResources();
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "dimen", context.getPackageName());

    if (resIdApp != 0) {
      TypedValue value = getTypedValueFromResource(appResource, resIdApp, TypedValue.TYPE_DIMENSION);
      partnerResourceCache.put(resourceConfig, value);
      result =
              getDimensionFromTypedValue(
                      context, (TypedValue) partnerResourceCache.get(resourceConfig));
  ...
  public float getFraction(
    ...
    Resources appResource = context.getResources();
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "fraction", context.getPackageName());
  ...
  public int getInteger(@NonNull Context context, PartnerConfig resourceConfig, int defaultValue) {
    ...
    Resources appResource = context.getResources();
    int resIdApp = appResource.getIdentifier(resourceConfig.getResourceName(), "integer", context.getPackageName());
